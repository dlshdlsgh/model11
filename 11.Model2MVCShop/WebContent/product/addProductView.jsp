...
<body bgcolor="#ffffff" text="#000000" method="post">
	...
	<form name="detailForm" method="post" enctype="multipart/form-data">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01"><input type="radio" name="kind"
					value="기타">기타 <input type="radio" name="kind" value="식료품">식료품
					<input type="radio" name="kind" value="가전제품">가전제품 <input
					type="radio" name="kind" value="자동차">자동차</td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="manuDate"
					readonly="readonly" class="ct_input_g" id="datepicker"
					style="width: 100px; height: 19px" maxLength="8" minLength="6" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
